...
export class StreamElement extends HTMLElement {
  /** @static
   * @param {StreamElement} newElement
...
/** @typedef {(currentElement: StreamElement) => Promise<void>} Render */
/** @typedef {CustomEvent<{ newStream: StreamElement; render: Render }>} TurboBeforeStreamRenderEvent */
